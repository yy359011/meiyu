...
const SONG_LYRICS: LyricLine[] = [
  { time: 0, text: "我是桥，我从画板来" },
  { time: 4, text: "扁担长，板凳宽，我是大扁担" },
  { time: 8, text: "我是桥，我向云端开" },
  { time: 12, text: "跨江河，越山海，天堑变通途" },
  { time: 18, text: "我是路，我在高原在" },
  { time: 22, text: "朝发夕至，一步跨千年" },
  { time: 26, text: "我是梦，我在新时代" },
  { time: 30, text: "云岭深处，匠心筑未来" },
  { time: 36, text: "顶天立地，是我的气概" },
  { time: 40, text: "开天辟地，是我的情怀" },
  { time: 44, text: "经天纬地，是我的风采" },
  { time: 48, text: "改天换地，是我的豪迈" },
  { time: 52, text: "（桥段）" },
  { time: 54, text: "缩短距离的路，连接万物的道" },
  { time: 58, text: "钢筋写山河，热血铸荣耀" },
  { time: 62, text: "融通天下，通达四海" },
  { time: 66, text: "云交院人，永远在路上" },
  { time: 72, text: "我是桥，向未来盛开！" },
];

// 校歌音频文件路径
const DEFAULT_AUDIO_URL = new URL('../assets/images/我是桥 MMM (合唱版F 调) 2025.01.06-2.mp3', import.meta.url).href;
