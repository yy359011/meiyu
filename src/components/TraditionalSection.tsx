          ...
          >
            ...
            <div className="md:col-span-2 flex flex-col space-y-3.5">
              ...
              <div className="space-y-3 max-h-[360px] overflow-y-auto pr-1">
                {currentContent.rightList.map((item, idx) => (
                  <div
                    key={item.id}
                    onMouseEnter={() => setHoveredIndex(idx)}
                    onMouseLeave={() => setHoveredIndex(null)}
                    onClick={() => {
                      // Interchange list item with main video for amazing interactive feels
                      onPlayVideo(item.title, 'https://assets.mixkit.co/videos/preview/mixkit-hand-writing-with-ink-on-paper-34351-large.mp4');
                    }}
